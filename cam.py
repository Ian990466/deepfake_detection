...
if __name__ == '__main__':
    ...
    # load model
    print('Loading model...')
    state_tmp = torch.load("./weights/binclass/net-EfficientNetCA_traindb-ff-c23-720-140-140_face-scale_size-224_seed-41/bestval.pth")
    ...
    target_layers = [net.efficientnet._blocks[29]]
    print(target_layers)
