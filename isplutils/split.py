...
def load_df(
    dfdc_df_path: str, ffpp_df_path: str, celeb_df_path: str, 
    dfdc_faces_dir: str, ffpp_faces_dir: str, celeb_faces_dir: str,
    dataset: str
    ) -> (pd.DataFrame, str):
...
def make_splits(
    dfdc_df: str, ffpp_df: str, celeb_df: str, 
    dfdc_dir: str, ffpp_dir: str, celeb_dir: str, 
    ...
    for split_name, split_dbs in dbs.items():
        ...
        for split_db in split_dbs:
            if split_db not in full_dfs:
                full_dfs[split_db] = load_df(dfdc_df, ffpp_df, celeb_df, dfdc_dir, ffpp_dir, celeb_dir, split_db)
