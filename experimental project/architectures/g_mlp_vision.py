    ...
    def __init__(
        ...
        *,
        ...
        self.layers = nn.ModuleList(
            [Residual(PreNorm(dim, gMLPBlock(dim = dim, heads = heads, dim_ff = dim_ff, seq_len = num_patches, attn_dim = attn_dim))) for i in range(depth)]
        )

        # self.ff = nn.Sequential(
        #     nn.LayerNorm(dim),
        #     Rearrange('b (n n1) (d d1) -> b  (n1 d1)'),
        # )
