...
class EfficientNetAtt(EfficientNet):
    def init_att(self):
        ...
        self.sa0 = SpatialAttention(24)
        self.sa1 = SpatialAttention(32)
        self.sa2 = SpatialAttention(56)
        self.sa3 = SpatialAttention(112)
        self.sa4 = SpatialAttention(160)
        self.sa5 = SpatialAttention(272)
        self.sa6 = SpatialAttention(448)
...
class EfficientNetCA(FeatureExtractor):
    def __init__(self):
        super(EfficientNetCA, self).__init__()
