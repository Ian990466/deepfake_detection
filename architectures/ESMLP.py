...
class EgMLP_Gen(FeatureExtractor):
    def __init__(self, model: str, width: int):
        super(EgMLP_Gen, self).__init__()
...
class EgMLP(EgMLP_Gen):
    def __init__(self):
        super(EgMLP, self).__init__(model='efficientnet-b4', width=0)
